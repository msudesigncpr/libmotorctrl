...
PETRI_DISH_COORDINATES = [
    PetriDish(x=2600, y=-2460),
    PetriDish(x=2600, y=-2460),
    PetriDish(x=7100, y=-2460),
    PetriDish(x=11600, y=-2460),
    PetriDish(x=16100, y=-2460),
    PetriDish(x=2600, y=2290),
    PetriDish(x=7100, y=2290),
]
...
for colony in VALID_COLONIES:
    ...
    drive_ctrl.move(
        STERILIZER_COORDINATES[0], STERILIZER_COORDINATES[1], STERILIZER_COORDINATES[2]
    )
